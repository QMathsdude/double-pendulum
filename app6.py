...
class DoublePendulumApp(tb.Frame):
    ...
    def create_graphs(self):
        ...
        # Create 1X3 grid for graphs
        for i in range(3): self.graph_frame.columnconfigure(i, weight=1)
        ...
        self.ax1.set_aspect('auto', adjustable='box')
        ...
        self.canvas1.get_tk_widget().grid(row=0, column=0, sticky=NSEW, pady=0)
        ...
        self.canvas2.get_tk_widget().grid(row=0, column=1, sticky=NSEW, pady=0)
    ...
    def create_playback(self):
        ...
        # Checks for change in the meter value
